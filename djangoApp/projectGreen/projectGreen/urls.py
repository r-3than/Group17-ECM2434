...
from projectGreen.views import flag_submission, home,challenge, like_submission,submit,uploadphoto, specific_group_access, post, create_comment, flag_comment, account, friends, friends_feed, deleteAccount, signout, addFriend, removeFriend, declineFriendRequest, acceptFriendRequest, leaderboard
